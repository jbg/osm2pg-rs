...
impl HeaderBlock {
    ...
    // optional .osm_pbf.HeaderBBox bbox = 1;
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<HeaderBlock>(
                    "HeaderBlock",
                    fields,
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<HeaderBBox>(
                    "HeaderBBox",
                    fields,
                    file_descriptor_proto()
                )
...
impl PrimitiveBlock {
    ...
    // required .osm_pbf.StringTable stringtable = 1;
    ...
    // repeated .osm_pbf.PrimitiveGroup primitivegroup = 2;
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<PrimitiveBlock>(
                    "PrimitiveBlock",
                    fields,
                    file_descriptor_proto()
                )
...
impl PrimitiveGroup {
    ...
    // optional .osm_pbf.DenseNodes dense = 2;
    ...
    // repeated .osm_pbf.Relation relations = 4;
    ...
    // repeated .osm_pbf.ChangeSet changesets = 5;
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<PrimitiveGroup>(
                    "PrimitiveGroup",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<StringTable>(
                    "StringTable",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<DenseInfo>(
                    "DenseInfo",
                    fields,
                    file_descriptor_proto()
                )
...
impl DenseNodes {
    ...
    // optional .osm_pbf.DenseInfo denseinfo = 5;
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<DenseNodes>(
                    "DenseNodes",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<Way>(
                    "Way",
                    fields,
                    file_descriptor_proto()
                )
...
impl Relation {
    ...
    // repeated .osm_pbf.Relation.MemberType types = 10;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0fosmformat.proto\x12\x07osm_pbf\"\x9a\x02\n\x0bHeaderBlock\x12#\n\
    \x04bbox\x18\x01\x20\x01(\x0b2\x13.osm_pbf.HeaderBBoxB\0\x12\x1b\n\x11re\
    quired_features\x18\x04\x20\x03(\tB\0\x12\x1b\n\x11optional_features\x18\
    \x05\x20\x03(\tB\0\x12\x18\n\x0ewritingprogram\x18\x10\x20\x01(\tB\0\x12\
    \x10\n\x06source\x18\x11\x20\x01(\tB\0\x12'\n\x1dosmosis_replication_tim\
    estamp\x18\x20\x20\x01(\x03B\0\x12-\n#osmosis_replication_sequence_numbe\
    r\x18!\x20\x01(\x03B\0\x12&\n\x1cosmosis_replication_base_url\x18\"\x20\
    \x01(\tB\0:\0\"P\n\nHeaderBBox\x12\x0e\n\x04left\x18\x01\x20\x02(\x12B\0\
    \x12\x0f\n\x05right\x18\x02\x20\x02(\x12B\0\x12\r\n\x03top\x18\x03\x20\
    \x02(\x12B\0\x12\x10\n\x06bottom\x18\x04\x20\x02(\x12B\0:\0\"\xe2\x01\n\
    \x0ePrimitiveBlock\x12+\n\x0bstringtable\x18\x01\x20\x02(\x0b2\x14.osm_p\
    bf.StringTableB\0\x121\n\x0eprimitivegroup\x18\x02\x20\x03(\x0b2\x17.osm\
    _pbf.PrimitiveGroupB\0\x12\x1a\n\x0bgranularity\x18\x11\x20\x01(\x05:\
    \x03100B\0\x12\x17\n\nlat_offset\x18\x13\x20\x01(\x03:\x010B\0\x12\x17\n\
    \nlon_offset\x18\x14\x20\x01(\x03:\x010B\0\x12\x20\n\x10date_granularity\
    \x18\x12\x20\x01(\x05:\x041000B\0:\0\"\xc8\x01\n\x0ePrimitiveGroup\x12\
    \x1e\n\x05nodes\x18\x01\x20\x03(\x0b2\r.osm_pbf.NodeB\0\x12$\n\x05dense\
    \x18\x02\x20\x01(\x0b2\x13.osm_pbf.DenseNodesB\0\x12\x1c\n\x04ways\x18\
    \x03\x20\x03(\x0b2\x0c.osm_pbf.WayB\0\x12&\n\trelations\x18\x04\x20\x03(\
    \x0b2\x11.osm_pbf.RelationB\0\x12(\n\nchangesets\x18\x05\x20\x03(\x0b2\
    \x12.osm_pbf.ChangeSetB\0:\0\"\x1c\n\x0bStringTable\x12\x0b\n\x01s\x18\
    \x01\x20\x03(\x0cB\0:\0\"\x7f\n\x04Info\x12\x15\n\x07version\x18\x01\x20\
    \x01(\x05:\x02-1B\0\x12\x13\n\ttimestamp\x18\x02\x20\x01(\x03B\0\x12\x13\
    \n\tchangeset\x18\x03\x20\x01(\x03B\0\x12\r\n\x03uid\x18\x04\x20\x01(\
    \x05B\0\x12\x12\n\x08user_sid\x18\x05\x20\x01(\rB\0\x12\x11\n\x07visible\
    \x18\x06\x20\x01(\x08B\0:\0\"\x8c\x01\n\tDenseInfo\x12\x13\n\x07version\
    \x18\x01\x20\x03(\x05B\x02\x10\x01\x12\x15\n\ttimestamp\x18\x02\x20\x03(\
    \x12B\x02\x10\x01\x12\x15\n\tchangeset\x18\x03\x20\x03(\x12B\x02\x10\x01\
    \x12\x0f\n\x03uid\x18\x04\x20\x03(\x11B\x02\x10\x01\x12\x14\n\x08user_si\
    d\x18\x05\x20\x03(\x11B\x02\x10\x01\x12\x13\n\x07visible\x18\x06\x20\x03\
    (\x08B\x02\x10\x01:\0\"\x1b\n\tChangeSet\x12\x0c\n\x02id\x18\x01\x20\x02\
    (\x03B\0:\0\"w\n\x04Node\x12\x0c\n\x02id\x18\x01\x20\x02(\x12B\0\x12\x10\
    \n\x04keys\x18\x02\x20\x03(\rB\x02\x10\x01\x12\x10\n\x04vals\x18\x03\x20\
    \x03(\rB\x02\x10\x01\x12\x1d\n\x04info\x18\x04\x20\x01(\x0b2\r.osm_pbf.I\
    nfoB\0\x12\r\n\x03lat\x18\x08\x20\x02(\x12B\0\x12\r\n\x03lon\x18\t\x20\
    \x02(\x12B\0:\0\"\x80\x01\n\nDenseNodes\x12\x0e\n\x02id\x18\x01\x20\x03(\
    \x12B\x02\x10\x01\x12'\n\tdenseinfo\x18\x05\x20\x01(\x0b2\x12.osm_pbf.De\
    nseInfoB\0\x12\x0f\n\x03lat\x18\x08\x20\x03(\x12B\x02\x10\x01\x12\x0f\n\
    \x03lon\x18\t\x20\x03(\x12B\x02\x10\x01\x12\x15\n\tkeys_vals\x18\n\x20\
    \x03(\x05B\x02\x10\x01:\0\"j\n\x03Way\x12\x0c\n\x02id\x18\x01\x20\x02(\
    \x03B\0\x12\x10\n\x04keys\x18\x02\x20\x03(\rB\x02\x10\x01\x12\x10\n\x04v\
    als\x18\x03\x20\x03(\rB\x02\x10\x01\x12\x1d\n\x04info\x18\x04\x20\x01(\
    \x0b2\r.osm_pbf.InfoB\0\x12\x10\n\x04refs\x18\x08\x20\x03(\x12B\x02\x10\
    \x01:\0\"\xea\x01\n\x08Relation\x12\x0c\n\x02id\x18\x01\x20\x02(\x03B\0\
    \x12\x10\n\x04keys\x18\x02\x20\x03(\rB\x02\x10\x01\x12\x10\n\x04vals\x18\
    \x03\x20\x03(\rB\x02\x10\x01\x12\x1d\n\x04info\x18\x04\x20\x01(\x0b2\r.o\
    sm_pbf.InfoB\0\x12\x15\n\troles_sid\x18\x08\x20\x03(\x05B\x02\x10\x01\
    \x12\x12\n\x06memids\x18\t\x20\x03(\x12B\x02\x10\x01\x12/\n\x05types\x18\
    \n\x20\x03(\x0e2\x1c.osm_pbf.Relation.MemberTypeB\x02\x10\x01\"/\n\nMemb\
    erType\x12\x08\n\x04NODE\x10\0\x12\x07\n\x03WAY\x10\x01\x12\x0c\n\x08REL\
    ATION\x10\x02\x1a\0:\0B\0b\x06proto2\
";
